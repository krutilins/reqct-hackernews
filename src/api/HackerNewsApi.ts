...
export const getTopNewsIds = (): Promise<number[]> => fetch('https://hacker-news.firebaseio.com/v0/newstories.json')
  .then(async (response) => {
...
export const getItemById = (id: number): Promise<HackerNewsItem> => fetch(`https://hacker-news.firebaseio.com/v0/item/${id}.json`)
